...
m4_define(m4_maxoutfiledays, 30)m4_dnl
...
m4_dnl Titles
m4_dnl
m4_define(m4_progname, `cltl-magicplace')m4_dnl
m4_define(m4_progrepo, `https://github.com/PaulHuygen/cltl-magicplace.git')m4_dnl
